    ...
    <div className="min-h-screen flex flex-col bg-[#fcfaf7]">
      <header className="sticky top-0 z-50 glass border-b border-stone-200">
        <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-10 text-sm font-bold text-stone-500 uppercase tracking-widest">
          ...
          <div className="flex items-center gap-4">
             <button className="hidden sm:block text-xs font-bold uppercase tracking-widest text-emerald-600 bg-emerald-50 px-5 py-2.5 rounded-full hover:bg-emerald-100 transition-colors">
               Pro Login
             </button>
          </div>
        </div>
      ...
      <footer className="bg-stone-50 border-t border-stone-200 py-12 mt-20">
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex md:justify-end gap-6 text-stone-300">
            <a href="#" className="hover:text-emerald-500"><i className="fab fa-instagram text-xl"></i></a>
            <a href="#" className="hover:text-emerald-500"><i className="fab fa-linkedin-in text-xl"></i></a>
            <a href="#" className="hover:text-emerald-500"><i className="fab fa-twitter text-xl"></i></a>
          </div>
        </div>
      </footer>
    </div>
